...
export const features: FeatureConfig[] = [
  ...
  },
  {
    ...
    longDescription: "Empower your organization with SynapseAI's predictive analytics to make proactive, data-driven decisions. By identifying complex patterns and subtle trends in your historical and real-time data, our platform forecasts future outcomes with high confidence. This is crucial for strategic financial forecasting, optimizing supply chains, personalizing customer experiences, and identifying emerging market opportunities or potential risks.",
    category: 'Core Technology',
  ...
  },
  {
    ...
    longDescription: "Revolutionize your development workflows with SynapseAI's intelligent code generation. Describe your software requirements in natural language or through high-level specifications, and let our AI assist in writing clean, efficient, and maintainable code snippets or entire modules across various programming languages. Significantly boost developer productivity, reduce human error, and accelerate your time-to-market for new software solutions and updates.",
    category: 'Core Technology',
