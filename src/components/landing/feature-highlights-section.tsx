...
export function FeatureHighlightsSection() {
  const unifiedPlatformFeature = platformCapabilities[0]; 
    ...
    <section className="py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <AppearOnScroll animationClassName="animate-slide-in-from-left" delay="[animation-delay:0.2s]" className="order-2 md:order-1">
            <div>
          ...
          <AppearOnScroll animationClassName="animate-slide-in-from-right" delay="[animation-delay:0.4s]" className="order-1 md:order-2 group">
